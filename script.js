...
const allBaseAnswersEn = [...baseAnswersEn, ...simpleAnswersEn];
const allBaseAnswersZh = [...baseAnswersZh, ...simpleAnswersZh];
const answers = allBaseAnswersEn.flatMap((baseEn, index) =>
  answerEndingsEn.map((endingEn, endingIndex) => ({
    en: `${baseEn}${endingEn}`,
    zh: `${allBaseAnswersZh[index]}${answerEndingsZh[endingIndex]}`
  }))
);
